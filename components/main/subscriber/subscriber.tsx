...
<div className={styles.subscriber}>
 ...
 <button>Subscribe</button>
             ...
             <div className={styles.sub2}>
                 <div className={styles.sub21}> <Image src="/images/Rectangle.png" width={231} height={432} id="phone"/>
                 ...
                 <div className={styles.sub22}><div><p>Enter your number and receive a direct link to download the app</p></div>
                    ...
                    <a href=""><Image src="/images/appstore.svg"  width={135} height={40} /></a> 
                     <a href=""><Image src="/images/playstore.svg"  width={135} height={40} /></a>
                 </div>
                </div>
                <div className={styles.sub23}>
                 <div className={styles.sub221}>
                     <p>Get in on</p>
                     <a href=""><Image src="/images/appstore.svg"  width={135} height={40} /></a> 
                      <a href=""><Image src="/images/playstore.svg"  width={135} height={40} /></a></div>
